                    ...
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <div class="col-lg-6 col-xl-5">
                                ...
                                <form action="<?php echo base_url('register/user') ?>" enctype="multipart/form-data" method="post">
                                    ...
                                    <button class="btn btn-primary w-100 mb-7 rounded-pill" type="submit">Sign Up</button>
                                    <a href="<?php echo base_url('login') ?>"> <button class="btn btn-primary w-100 mb-7 rounded-pill" type="button">Kembali ke Login</button>
                                    </a>
